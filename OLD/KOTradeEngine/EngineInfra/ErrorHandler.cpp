...
void ErrorHandler::init(bool bIsAppend, string sLogLevel)
{
    ...
    if(!ofsErrorWarningFile.is_open())
    {
        if(bIsAppend)
        {
            ofsErrorWarningFile.open("ErrorWarning.out", fstream::out | fstream::app);
        }
        else
        {
            ofsErrorWarningFile.open("ErrorWarning.out", fstream::out);
        }

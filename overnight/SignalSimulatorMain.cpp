...
int main(int argc, char *argv[])
{
    ...
    if(stat(sDataFile.c_str(), &buffer) == 0)
    {
        ...
        {
            int iPortfolioID = cExecutorSim.iaddPortfolio(sDate, &(vResultH5Files[signalFileIdx]), vSignalFileDirs[signalFileIdx] + "/overnightpos.csv", &cSimTransactionType, NULL);

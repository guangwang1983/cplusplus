...
public:
    ...
    int iaddPortfolio(string sDate, H5File* pH5File, string sOvernightPosFileName, CompType* pTransactionDataType, SchedulerBase* pSchedulerBase);
...
private:
    ...
    map< boost::gregorian::date, int > _mDailyOvernightPos;

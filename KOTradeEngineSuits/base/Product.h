...
public:
	...
	void useWeightedStdev(long iStdevLength, bool bDailyUpdate, KOEpochTime cUpdateTime, int iUpdateFreqSeconds, KOEpochTime cWeightedStdevStartTime, KOEpochTime cWeightedStdevEndTime, bool bDetrend);
    ...
    void useStaticStdev();
    void setStaticStdev(double dStaticStdev);
    double dgetStaticStdev();

    void setRollParams(double dRollAdjust, double dRollDelta);
...
protected:
    ...
    bool _bUseStaticStdev;
    double _dStaticStdev;

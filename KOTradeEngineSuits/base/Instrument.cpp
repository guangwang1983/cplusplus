...
void Instrument::setIsLiveTrading(bool bIsLiveTrading)
{
...
void Instrument::newMarketUpdate(QuoteData* pNewPriceData)
{
    ...
    if(_bUseRealSignalPrice)
    {
        _dWeightedMid = pNewPriceData->dWeightedMid;
        _dWeightedMid = (pNewPriceData->dWeightedMid - _dRollDelta) / _dRollAdjust;
    }
    else
    {
        _dWeightedMid = pNewPriceData->dWeightedMidInTicks;
        _dWeightedMid = (pNewPriceData->dWeightedMidInTicks - _dRollDelta) / _dRollAdjust;
    }
